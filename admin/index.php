...
<div class="col-xl-8 col-lg-7">
    ...
    <div class="card shadow mb-4">
        ...
        <?php
        include 't/db_conn.php';
            $sql = "SELECT COUNT(*) as total FROM checkup WHERE CKD_Status = 'Stage 1'";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $stage1 = $row['total'];

            $sql = "SELECT COUNT(*) as total FROM checkup WHERE CKD_Status = 'Stage 2'";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $stage2 = $row['total'];

            $sql = "SELECT COUNT(*) as total FROM checkup WHERE CKD_Status = 'Stage 3A'";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $stage3 = $row['total'];

            $sql = "SELECT COUNT(*) as total FROM checkup WHERE CKD_Status = 'Stage 3B '";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $stage3b = $row['total'];

            $sql = "SELECT COUNT(*) as total FROM checkup WHERE CKD_Status = 'Stage 4'";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $stage4 = $row['total'];

            $sql = "SELECT COUNT(*) as total FROM checkup WHERE CKD_Status = 'Stage 5'";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $stage5 = $row['total'];
