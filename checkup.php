        ...
        <body>
            ...
            <div class="bueno-search-area section-padding-100-0 pb-70 bg-img" style="background-image: url(img/core-img/pattern.png);">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <form action="http://localhost:8000/predict" method="post" id="checkup-form">
                                <div class="row">
...
<script>
  ...
  function calculateEGFR() {
    ...
    const creatinineUMOL = creatinineInput.value;

    // convert creatinine from umol/L to mg/dL
    const creatinineMGDL = creatinineUMOL * 0.011312217194570135;

    // calculate eGFR based on gender and SCr value in mg/dL
    let GFR;
    if (gender === "Female") {
      if (creatinineMGDL < 0.7) {
        GFR = 144 * (creatinineMGDL / 0.7) ** -0.329 * (0.993 ** age);
      } else {
        GFR = 144 * (creatinineMGDL / 0.7) ** -1.209 * (0.993 ** age);
      }
    } else if (gender === "Male") {
      if (creatinineMGDL < 0.9) {
        GFR = 141 * (creatinineMGDL / 0.9) ** -0.411 * (0.993 ** age);
      } else {
        GFR = 141 * (creatinineMGDL / 0.9) ** -1.209 * (0.993 ** age);
      }
    }

    // display eGFR on the input field
    displayEGFR(GFR.toFixed(2));
  }

  function displayEGFR(value) {
    eGFRInput.value = value + " mL/min/1.73m²";
  }
</script>
                            ...
                            <center>
                                <div class="col-12">
                                    <div class="form-group mb-30">
                                        <button class="btn bueno-btn mt-30">Submit</button>
                                    </div>
                                </div>
                            </center>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-5">
                            ...
                            <p class="copywrite-text"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                ...
                                </script> CKD Monitoring & Food recommendation </a>
